...
module.exports.calculateMobMana = level => Math.floor(8 + 1.18 * level);
...
module.exports.exploreMana = level => Math.floor(this.calculateMana(level - (level - 1) % 5) * 20/100);
module.exports.buryExp = rarity => Math.floor(3000 / rarity);